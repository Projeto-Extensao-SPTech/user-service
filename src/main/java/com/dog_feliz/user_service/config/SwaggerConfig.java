    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("Esta API disponibiliza os serviços e recursos do sistema Abrigo Dog Feliz, permitindo o gerenciamento de adoções, cadastro de animais, voluntários e doações de forma integrada e eficiente.")
                        .contact(new Contact()
