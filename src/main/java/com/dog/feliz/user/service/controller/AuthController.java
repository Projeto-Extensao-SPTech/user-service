...
import com.dog.feliz.user.service.controller.dto.AuthRequestDto;
import com.dog.feliz.user.service.controller.dto.AuthResponseDto;
import com.dog.feliz.user.service.controller.dto.RefreshTokenRequestDto;
...
import com.dog.feliz.user.service.service.AuthService;
import com.dog.feliz.user.service.service.JwtService;
import com.dog.feliz.user.service.service.TokenService;
...
public class AuthController {
    ...
    public ResponseEntity<UserResponseDto> register(@RequestBody @Valid UserRequestDto userRequestDto) {
        ...
        logger.info("[REGISTER_USER] User registered successfully by request: {}", userRequestDto);
    ...
    public ResponseEntity<AuthResponseDto> authenticate(
        ...
        AuthResponseDto authResponseDto = new AuthResponseDto(
                tokenObject.getFirst(),
                tokenObject.getSecond(),
                authenticatedUser
        );
        logger.info("[LOGIN_USER] User authorized to login successfully by request={}", authRequestDto);
    ...
    public ResponseEntity<AuthResponseDto> refresh(
        ...
        Pair<String, String> tokenObject = tokenService.generateToken(
                authenticatedUser,
        ...
        logger.info("[LOGIN_REFRESH_USER] User authorized to login refresh successfully");
        return ResponseEntity.ok(authResponseDto);
    }
}
